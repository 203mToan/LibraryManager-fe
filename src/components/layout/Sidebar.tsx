import { BookOpen, Users, BookMarked, FolderTree, UserCircle, BarChart3, FileText, Home, LogOut } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white flex flex-col h-screen">
      <div className="p-6 border-b border-slate-700">
        ...
        <p className="text-sm text-slate-400 mt-1">{user?.role === 'manager' ? 'Cổng quản lý' : 'Cổng thành viên'}</p>
      </div>
